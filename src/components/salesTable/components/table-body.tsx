...
export function TableBody({
  ...
  const handleOrderStatusChange = (sale: SaleItem, newStatus: string) => {
    ...
    handleStatusChange(String(sale.id), newStatus);
  };
  ...
  const handleDarazCancelSubmit = async () => {
    ...
    try {
      ...
      await handleStatusChange(darazCancelDialog.saleId, "Cancelled");
  ...
  const getOrderStatusColor = (status: string) => {
    switch (status) {
      case "Returned By PicknDrop":
        return "bg-red-500"; // Red for returned by customer
      case "Sent to PicknDrop":
        return "bg-blue-500"; // Pink for sent to PicknDrop
      case "Sent to Daraz":
        return "bg-amber-500"; // Amber for sent to Daraz
      case "Delivered":
      ...
      case "Returned By Daraz":
        return "bg-fuchsia-500"; // Fuchsia for returned by daraz
      case "Return Pending":
  ...
  return (
    <>
                      ...
                      {column.id === "index" ? (
                        ...
                        <div className="flex items-center">
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleOrderStatusChange(sale, value)
                            }
                          >
                            ...
                            <SelectContent className="bg-white border border-gray-300 rounded-md shadow-lg">
                              ...
                              <SelectItem value="Sent to Daraz">
                                <span
                                  className={
                                    getOrderStatusColor("Sent to Daraz") +
                                    " rounded-full w-4 h-4 inline-block mr-2"
                                  }
                                ></span>
                                Sent to Daraz
                              ...
                              <SelectItem value="Returned By PicknDrop">
                                <span
                                  className={
                                    getOrderStatusColor(
                              ...
                              <SelectItem value="Returned By Daraz">
                                <span
                                  className={
                                    getOrderStatusColor("Returned By Daraz") +
                                    " rounded-full w-4 h-4 inline-block mr-2"
                                  }
                                ></span>
                                Returned By Daraz
      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open) closeDarazCancelDialog();
        }}
      >
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={darazCancelDialog.isSubmitting}
            >
              {darazCancelDialog.isSubmitting
                ? "Cancelling..."
                : "Cancel Order"}
            </Button>
          </DialogFooter>
