...
const AddProduct: React.FC<AddProductProps> = ({ onClose }) => {
  ...
  const watchDistributorId = form.watch("distributor_id");
    ...
    const fetchFranchises = async () => {
      ...
      try {
        const response = await fetch(
          `https://sales.baliyoventures.com/api/account/distributors/${watchDistributorId}/franchises/`
        );
        if (response.ok) {
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        ...
                        defaultValue={field.value}
                        disabled={
                          !watchDistributorId || franchises.length === 0
                        }
                      >
                        <SelectTrigger>
                          <SelectValue
